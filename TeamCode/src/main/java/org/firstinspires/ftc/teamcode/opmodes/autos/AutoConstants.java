...
public class AutoConstants {
    ...
    // Start Point: x: 29.854, y: 133.901, startDeg: 144
    public static final Pose BLUE_START_POSE = new Pose(29.854, 133.901, toRadians(144));
    public static final Pose RED_START_POSE = new Pose(119.146, 128.901, toRadians(36));

    // FAR Side (Observation Zone Side)
    // Start Point: x: 52.892, y: 13.063, startDeg: 90
    public static final Pose BLUE_FAR_START_POSE = new Pose(52.892, 13.063, toRadians(90));
    ...
    // Scoring Pose (Basket)
    // Score Point: x: 72.88, y: 80.72, endDeg: 135
    public static final Pose BLUE_BASKET_POSE = new Pose(72.88, 80.72, toRadians(135));
    ...
    public static final Pose BLUE_FAR_SHOOT_POSE = new Pose(67.889, 21.287, toRadians(203.25));
    ...
    // Sample 1 (Rightmost/First one): x: 28.785, y: 88.87, endDeg: 180
    public static final Pose BLUE_SAMPLE_1_POSE = new Pose(28.785, 88.87, toRadians(180));
    ...
    public static final Pose BLUE_SAMPLE_2_INTERMEDIATE = new Pose(47.49, 64.95, toRadians(180));
    public static final Pose RED_SAMPLE_2_INTERMEDIATE = new Pose(101.51, 59.95, toRadians(0));
    
    public static final Pose BLUE_SAMPLE_2_POSE = new Pose(29.05, 64.82, toRadians(180));
    ...
    public static final Pose BLUE_SAMPLE_3_INTERMEDIATE = new Pose(47.09, 41.03, toRadians(180));
    public static final Pose RED_SAMPLE_3_INTERMEDIATE = new Pose(101.91, 36.03, toRadians(0));
    
    public static final Pose BLUE_SAMPLE_3_POSE = new Pose(28.92, 40.63, toRadians(180));
    public static final Pose RED_SAMPLE_3_POSE = new Pose(120.08, 35.63, toRadians(0));

    // =========================================================
    // Gate Poses (Added per user request)
    // =========================================================
    public static final Pose BLUE_GATE_POSE = new Pose(20.266, 74.725, toRadians(0));
    ...
    public static final Pose BLUE_PARK_POSE = new Pose(110.477, 38.323, toRadians(90));
