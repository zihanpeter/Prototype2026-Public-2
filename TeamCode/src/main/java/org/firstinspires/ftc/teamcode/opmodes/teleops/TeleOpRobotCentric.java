...
public class TeleOpRobotCentric extends CommandOpMode {
    ...
    public void initialize() {
        ...
        // Use a lambda for robot-centric drive instead of TeleOpDriveCommand which forces Field Centric
        drive.setDefaultCommand(new com.arcrobotics.ftclib.command.RunCommand(() -> {
            drive.moveRobot(-gamepadEx1.getLeftY(), gamepadEx1.getLeftX(), gamepadEx1.getRightX());
        }, drive));
