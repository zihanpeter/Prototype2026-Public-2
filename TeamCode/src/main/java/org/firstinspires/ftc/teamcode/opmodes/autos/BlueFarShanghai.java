...
public class BlueFarShanghai extends AutoCommandBase {
    ...
    private final Pose shootPose2 = new Pose(61, 11.89, Math.toRadians(112.5));
    ...
    private final Pose shootPose3 = new Pose(61, 11.89, Math.toRadians(123)); // Final shooting angle: 123 degrees
