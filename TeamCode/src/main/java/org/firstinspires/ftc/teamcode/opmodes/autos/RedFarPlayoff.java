...
/**
 * Autonomous OpMode for the Red Alliance Far side (Playoff version).
...
public class RedFarPlayoff extends AutoCommandBase {
    ...
    private final Pose shootPose1 = mirrorPose(new Pose(61, 11.89, Math.toRadians(112.5)));
    private final Pose pushStartPose = mirrorPose(new Pose(4, 25.316909294512882, Math.toRadians(270)));
    private final Pose pushEndPose = mirrorPose(new Pose(5.062709966405375, 9.83650615901455, Math.toRadians(270)));
    private final Pose shootPose3 = mirrorPose(new Pose(61, 11.89, Math.toRadians(123)));
    private final Pose parkPose = mirrorPose(new Pose(38.86226203807391, 12.094064949608057, Math.toRadians(90)));
    ...
    private void buildPaths() {
        ...
        path2_toPushStart = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(shootPose1Heading, pushStartHeading)
                .build();
